...
if (typeof serializers === 'undefined') {
  serializers = {};
}
if (typeof serializers.thrift === 'undefined') {
  serializers.thrift = {};
}
if (typeof serializers.thrift.media === 'undefined') {
  serializers.thrift.media = {};
}
serializers.thrift.media.Size = {
  'SMALL' : 0,
  'LARGE' : 1
};
serializers.thrift.media.Player = {
  'JAVA' : 0,
  'FLASH' : 1
};
serializers.thrift.media.Media = function(args) {
  this.uri = null;
  this.title = null;
  this.width = null;
  this.height = null;
...
serializers.thrift.media.Media.prototype = {};
serializers.thrift.media.Media.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 10:
      if (ftype == Thrift.Type.I32) {
        this.player = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
serializers.thrift.media.Media.prototype.write = function(output) {
...
serializers.thrift.media.Response = function(args) {
  this.code = 1;
  this.success = true;
  if (args) {
...
serializers.thrift.media.Response.prototype = {};
serializers.thrift.media.Response.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
serializers.thrift.media.Response.prototype.write = function(output) {
